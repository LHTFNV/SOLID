...
useradd -m -g users -G wheel -s /bin/bash solid
...
read -p "1 - XFCE, 2 - GNOME, 3 - Openbox: " vm_setting
if [[ $vm_setting == 1 ]]; then
  pacman -S xfce4 xfce4-goodies --noconfirm
elif [[ $vm_setting == 2 ]]; then
  pacman -Sy gnome gnome-extra --noconfirm
elif [[ $vm_setting == 3 ]]; then  
  pacman -S  openbox xfce4-terminal
fi

echo 'Какой ставим DM ?'
read -p "1 - gdm, 2 - lxdm: " dm_setting
...
echo 'Ставим шрифты'
pacman -S ttf-liberation ttf-dejavu ttf-fantasque-sans-mono --noconfirm 
